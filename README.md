# This project is simple React template with configured SSR and server-side script, that works with remote GraphQL to test SSR rendering with Apollo Client on the board.
